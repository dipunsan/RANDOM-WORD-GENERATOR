...
list1 = ["Anxious" , "Brave" , "Canyon" , "Delight" , "Enormous" , "Friendly" , "Glorious" , "Honour" , "Intelligent" , "Jackpot" , "King of Coding" , "Luminous"]
print(list1)
...
btn1.place(relx = 0.5, relly = 0.5, anchor = CENTER)
